...
ActiveRecord::Schema.define(version: 20151112025143) do
  ...
  create_table "hero_carousel_items", force: :cascade do |t|
  ...
  add_index "hero_carousel_items", ["position"], name: "index_hero_carousel_items_on_position", using: :btree

  create_table "hero_carousels", force: :cascade do |t|
    t.string   "name"
    t.string   "page_url"
    t.boolean  "active",     default: true
    t.datetime "created_at",                null: false
  ...
  add_index "hero_carousels", ["page_url"], name: "index_hero_carousels_on_page_url", using: :btree

  create_table "order_info_items", force: :cascade do |t|
    t.string "name"
    t.text   "description"
  end

  create_table "order_info_items_spree_products", id: false, force: :cascade do |t|
    t.integer "order_info_item_id", null: false
    t.integer "product_id",         null: false
  end

  add_index "order_info_items_spree_products", ["order_info_item_id"], name: "index_order_info_items_spree_products_on_order_info_item_id", using: :btree
  add_index "order_info_items_spree_products", ["product_id"], name: "index_order_info_items_spree_products_on_product_id", using: :btree

  create_table "promo_block_items", force: :cascade do |t|
  ...
  add_index "promo_block_items", ["position"], name: "index_promo_block_items_on_position", using: :btree
  ...
  add_index "promo_blocks", ["active"], name: "index_promo_blocks_on_active", using: :btree
  add_index "promo_blocks", ["page_url"], name: "index_promo_blocks_on_page_url", unique: true, using: :btree

  create_table "promo_strip_items", force: :cascade do |t|
  ...
  add_index "promo_strip_items", ["position"], name: "index_promo_strip_items_on_position", using: :btree

  create_table "promo_strip_layouts", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "promo_strips", force: :cascade do |t|
  ...
  add_index "promo_strips", ["default"], name: "index_promo_strips_on_default", using: :btree
  add_index "promo_strips", ["status"], name: "index_promo_strips_on_status", using: :btree

  create_table "promo_strips_spree_taxons", id: false, force: :cascade do |t|
    t.integer "promo_strip_id", null: false
    t.integer "taxon_id",       null: false
  end

  add_index "promo_strips_spree_taxons", ["promo_strip_id", "taxon_id"], name: "index_promo_strips_spree_taxons_on_promo_strip_id_and_taxon_id", using: :btree
  add_index "promo_strips_spree_taxons", ["taxon_id", "promo_strip_id"], name: "index_promo_strips_spree_taxons_on_taxon_id_and_promo_strip_id", using: :btree
  ...
  add_index "secondary_carousel_items", ["position"], name: "index_secondary_carousel_items_on_position", using: :btree

  create_table "secondary_carousels", force: :cascade do |t|
    t.string   "name"
    t.string   "title"
    t.string   "page_url"
    t.boolean  "active",     default: true
  ...
  add_index "secondary_carousels", ["page_url"], name: "index_secondary_carousels_on_page_url", using: :btree
  ...
  create_table "spree_custom_print_jobs", force: :cascade do |t|
    t.string   "status"
  ...
  add_index "spree_custom_print_jobs", ["spree_order_id"], name: "index_spree_custom_print_jobs_on_spree_order_id", using: :btree
  add_index "spree_custom_print_jobs", ["spree_user_id"], name: "index_spree_custom_print_jobs_on_spree_user_id", using: :btree
  ...
  add_index "spree_mega_menu_items", ["mega_menu_id"], name: "index_spree_mega_menu_items_on_mega_menu_id", using: :btree
  add_index "spree_mega_menu_items", ["parent_id"], name: "index_spree_mega_menu_items_on_parent_id", using: :btree
  ...
  add_index "spree_products", ["sale_unit_id"], name: "index_spree_products_on_sale_unit_id", using: :btree
